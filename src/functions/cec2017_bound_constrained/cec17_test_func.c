...
static void sum_diff_pow_func(double *, double *, int , double *,double *, int, int); /* Sum of different power */
static void zakharov_func(double *, double *, int , double *,double *, int, int); /* ZAKHAROV */
static void levy_func(double *, double *, int , double *,double *, int, int); /* Levy */
static void dixon_price_func(double *, double *, int , double *,double *, int, int); /* Dixon and Price */
...
static void hf07 (double *, double *, int, double *,double *, int *,int, int); /* Hybrid Function 7 */
static void hf08 (double *, double *, int, double *,double *, int *,int, int); /* Hybrid Function 8 */
static void hf09 (double *, double *, int, double *,double *, int *,int, int); /* Hybrid Function 9 */
static void hf10 (double *, double *, int, double *,double *, int *,int, int); /* Hybrid Function 10 */
...
static void cf07 (double *, double *, int , double *,double *, int); /* Composition Function 7 */
static void cf08 (double *, double *, int , double *,double *, int); /* Composition Function 8 */
static void cf09 (double *, double *, int , double *,double *, int *, int); /* Composition Function 9 */
static void cf10 (double *, double *, int , double *,double *, int *, int); /* Composition Function 10 */
